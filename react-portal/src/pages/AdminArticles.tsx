          ...
          <>
            ...
            <div className="p-4 border-b border-slate-200 dark:border-white/10 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-slate-900 dark:text-white truncate">{selected.title}</h2>
              </div>
            ...
            <div className="flex items-center gap-2 px-4 py-2 border-b border-slate-200 dark:border-white/10 shrink-0">
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all ${
                  !showPreview ? 'bg-primary/10 text-primary border border-primary/20' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-900 dark:hover:text-white'
                }`}
              >
                Edit
              </button>
            ...
            {/* Attachments section */}
            <div className="border-t border-slate-200 dark:border-white/10 px-4 py-3 shrink-0 bg-slate-100/40 dark:bg-slate-900/40">
