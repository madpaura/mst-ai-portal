...
async def create_solution_card(req: SolutionCardCreate, admin: dict = Depends(require_admin)):
    ...
    row = await db.fetchrow(
        ...
        INSERT INTO solution_cards
            (title, subtitle, description, long_description, icon, icon_color, badge, link_url, launch_url, sort_order, category)
...
async def update_solution_card(
    ...
    for field in [
        ...
        "icon_color", "badge", "link_url", "launch_url", "sort_order", "category", "is_active",
    ]:
